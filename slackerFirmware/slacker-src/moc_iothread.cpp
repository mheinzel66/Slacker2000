...
QT_MOC_LITERAL(4, 29, 15) // "onUsbDriveFound"

    },
    "IoThread\0stateChanged\0\0state\0"
    "onUsbDriveFound"
};
...
void IoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onUsbDriveFound(); break;
        default: ;
        }
        ...
        {
            typedef void (IoThread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IoThread::stateChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void IoThread::stateChanged(int _t1)
{
